    ...
    >
      ...
      <el-row>
        ...
        <el-col :lg="{ span: 2, offset: 6 }" :md="2">
          <el-button size="small" @click="uploadImg()" id="submit-btn">提 交</el-button>
        </el-col>
      </el-row>
    </el-dialog>
  </div>
...
.el-button {
  ...
  &:hover {
    background: #74f3a2 !important;
    color: #fff !important;
  }
  &:active {
    background: #fff;
    color: #25e16a !important;
  }
}
#submit-btn {
  background: #25e16a !important;
  color: #fff !important;

  &:hover {
    background: #43e77f !important;
  }
}
</style>
